...
void menuprint()
{
	...
	system("color 0e");
	gotoxy(0, 5);
	cout << "\t\t";	cout << " 	   שר 	       שÝשששששששששששששששששששששששששששß" << "\t      שששששששששÞשששששששש" << "\t          שר " << "     שר   שר           " << endl;
	cout << "\t\t"; cout << "	   שר 	       שר שששששששששששÞשששששששששש שר" << "\t          שר" << "\t          שר " << "     שר   שר   " << endl;
	cout << "\t\t"; cout << "    שÝשששששששששששששבשששששששששששששß    שר      שר      שר" << "\t          שר" << "\t        שששששבשששש" << "   שששבשששששששבשש " << endl;
